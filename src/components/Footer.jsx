const Footer = () => {
  return (
    <footer className="w-full flex flex-col items-center mt-4 mb-8">
      ...
      <a
        className="flex items-center gap-1 p-1 pr-2 bg-(--bg-top) text-(--color-top) rounded-4xl border border-transparent shadow-md hover:border-(--border-base) hover:shadow-[0_0_0_0_var(--color-muted)] hover:scale-[0.98] hover:opacity-80 duration-200"
        alt="pfp"
