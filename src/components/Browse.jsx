          ...
          <div className="w-11/12 md:w-1/2 flex justify-center flex-wrap gap-3 mt-10 mb-8 md:mt-4">
            {categories.map((category) => (
              <button
                ...
                className="px-3 py-1 rounded shadow-sm bg-(--bg-bottom) dark:bg-(--bg-top) dark:border dark:border-(--border-base) hover:scale-[0.98] hover:opacity-80 transition-transform transition-opacity duration-200 active:translate-y-1"
              >
                {category}
              </button>
            ))}
